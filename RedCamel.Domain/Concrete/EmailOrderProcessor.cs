...
namespace RedCamel.Domain.Concrete
{
    public class EmailSettings {
        public string MailToAddress = "RichardJGilbert@hotmail.com";
        public string MailFromAddress = "sales@redcamelcomics.co.uk";
        public bool UseSsl = false;  //TODO rectify
        public string Username = "sales@redcamelcomics.co.uk";
        public string Password = "tekken";
